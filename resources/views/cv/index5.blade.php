	...
	<div class="home-five-style">
		...
		<section class="hero-section">
			<div class="container-fluid text-center"  style="margin-top: 200px">
				<img src="{{ $user->profile_photo_url }}"  width="459px"  alt="">
				<div class="hero-text">
                    <h2>{{ $user->name }}</h2>
					<p>{{ substr($user->about_me,0,strlen($user->about_me)/2) }}<br>{{ substr($user->about_me,strlen($user->about_me)/2,strlen($user->about_me))  }}</p>
			    </div>
							...
							<div class="col-md-6">
								<div class="hero-info">
									<ul>
                                        ...
                                        <li><span>Phone </span><a href="{{ 'Tel:'.$user->phone }}" style="color: white;font-size: 17px;">{{ $user->phone }}</a></li>		</ul>
								</div>
							</div>
						</div>
					</div>
