                        ...
                        @if (!empty($user))
                            ...
                            <div class="col-lg-6">
                                <figure class="hero-image">
                                    <img src="{{ $user->profile_photo_url }}" width="499px" alt="{{ $user->name }}">
                                </figure>
                            </div>
                        @else
                            <div class="col-lg-6">
	...
	<section class="portfolio-section spad pb-0">
		<div class="container-fluid">
			...
			<div class="portfolio-warp">
				<div class="row">
                    @forelse ($user->portefolios as $item)
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="portfolio-item">
                                <a href="{{ $item->link_webite }}" class="set-bg port-pic" data-setbg="{{ $item->photo_website }}"></a>
                                <h2>{{ $item->name_website }}</h2>
                                <p>{{ $item->poste_website }}</p>
                            </div>
                        </div>
                    @empty
                        <div class="col-xl-3 col-lg-6 col-md-6">
